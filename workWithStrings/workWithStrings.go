// analyze order of opening and closing symbols in string
// colorize opening and closing symbols in string
// find the longest substring in alphabetical order of english alphabet
...
// analyze order of opening and closing symbols in stroka string
// parameters:
...
func analyze(stroka, openSymbol, closeSymbol string) {
	...
	var counter int = 0 // counter for opening symbols
...
// print coloured symbol with character ANCII code
...
// check if ANCII code corresponds to ANCII code of upper case english letter
// parameter: character - ANCII code
func isUpperCase(character rune) bool {
	return character >= 65 && character <= 90
}

// check if ANCII code corresponds to ANCII code of lower case english letter
// parameter: character - ANCII code
func isLowerCase(character rune) bool {
	return character >= 97 && character <= 122
}

// return ANCII code of upper case english letter corresponded to
// ANCII code of lower case english letter
// parameter: character - ANCII code
...
// parameter: stroka - string for analysis
func findLongestAlphabeticalPart(stroka string) {
	...
	var runeArray []rune                   // array with characters ANCII codes from stroka string
	...
	fmt.Println("The longest substring in alphabetical order is: ", strTemp2,
...
func main() {
	...
	// colorize opening and closing symbols in the str
	colorize(str, opening, closing)

	// analyze opening and closing symbols order in str
	analyze(str, opening, closing)

	// find the longest substring in alphabetical order of english alphabet in str
